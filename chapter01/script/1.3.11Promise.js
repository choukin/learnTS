...
var MyWebService = /** @class */ (function () {
    function MyWebService() {
    }
    MyWebService.prototype.CallExpensiveWebOperation = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, ExpensiveWEbCall(400)];
                    case 1:
                        _a.sent();
                        console.log("Finished web service");
                        return [2 /*return*/];
...
//# sourceMappingURL=1.3.11Promise.js.map